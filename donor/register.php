...
if (isset($_POST['register'])) {
	...
	function age($birthDate)
	{
		...
		if ($age > 18) {
			...
			$query = "insert into users values(null,'$_POST[name]','$_POST[email]','$_POST[password]','donor','$_POST[birthDate]',$_POST[mobile])";
			...
			echo "<script type='text/javascript'>
              alert('You  not eligible for blood donation.');
              window.location.href = 'login.php';
          </script>";
		}
	}
...
<body>
	...
	<div class="container">
		...
		<div class="img">
			<img src="img/9.jpeg" style="height:500px; width:600px;">
		</div>
	</div>
