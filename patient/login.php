...
if (isset($_POST['login'])) {
   ...
   $query = "select id,email,password,name from users where email = '$_POST[email]' AND password = '$_POST[password]' AND usertype = 'patient'";
...
<body>
   <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
      ...
      <ul>
         ...
         <li><a href="../homapage/index.html">Home</a></li>
      </ul>
   </nav>
