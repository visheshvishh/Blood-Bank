...
if(isset($_POST['login'])){
    ...
    $query = "select id,email,password,name from users where email = '$_POST[email]' AND password = '$_POST[password]' and usertype = 'admin'";
...
<body>
   ...
   <img class="wave" src="img/canva2.png">
   <div class="container">
      <div class="img">
         <img src="img/5.jpeg" style="height:500px; width:600px;">
      </div>
