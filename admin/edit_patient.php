<?php 
    ...
    if(isset($_POST['update_patient'])){
        $query = "update users set name = '$_POST[name]',email = '$_POST[email]',password = '$_POST[password]',mobile = $_POST[mobile] where id = $_GET[pid]";
    ...
    $query = "select * from users where id = $_GET[pid]";
...
<html>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <center><h4>Edit Recipient </h4></center>
