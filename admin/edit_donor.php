<?php 
    ...
    if(isset($_POST['update_donor'])){
        $query = "update users set name = '$_POST[name]',email = '$_POST[email]',password = '$_POST[password]',mobile = $_POST[mobile] where id = $_GET[did]";
    ...
    $query = "select * from users where id = $_GET[did]";
